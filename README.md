...
to make these skills easier to understand, maintain, and extend, I sometimes include a local documentation snapshot at`skills/<skill-name>/references/llm.md`.
