# Recherche Data Gouv MCP server on Modal
...
uvx modal run mcp/recherche-data-gouv/modal/mcp_server_stateless.py::test_tool \
    --tool-name search --arguments '{"q": "climat", "per_page": 3}'
```
...
```json
{
  "mcpServers": {
    "recherche-data-gouv": {
      "url": "https://<workspace>--smartbiblia-mcp-recherche-data-gouv-web.modal.run/mcp/"
    }
  }
}
```
