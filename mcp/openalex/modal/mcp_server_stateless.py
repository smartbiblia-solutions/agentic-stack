...
Tools served: `search_works`, `search_semantic`, `lookup_by_doi`, `get_citing_works`, `classify_text`.
...
Environment: OPENALEX_API_KEY — optional (polite pool). Without it the server
runs anonymously.
"""
