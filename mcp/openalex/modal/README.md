...
uvx modal run mcp/openalex/modal/mcp_server_stateless.py::test_tool \
    --tool-name search_works --arguments '{"query": "open science", "max_results": 3}'
```
...
```json
{
  "mcpServers": {
    "openalex": {
      "url": "https://<workspace>--smartbiblia-mcp-openalex-web.modal.run/mcp/"
    }
  }
}
```
