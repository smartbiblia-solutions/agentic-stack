# OpenCitations MCP server on Modal
...
uvx modal run mcp/opencitations/modal/mcp_server_stateless.py::test_tool \
    --tool-name get_citation_counts --arguments '{"doi": "10.1186/1756-8722-6-59"}'
```
...
```json
{
  "mcpServers": {
    "opencitations": {
      "url": "https://<workspace>--smartbiblia-mcp-opencitations-web.modal.run/mcp/"
    }
  }
}
```
