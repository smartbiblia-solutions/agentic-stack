...
uvx modal run mcp/theses-fr/modal/mcp_server_stateless.py::test_tool \
    --tool-name search_theses --arguments '{"q": "intelligence artificielle", "max_results": 3}'
```
...
```json
{
  "mcpServers": {
    "theses-fr": {
      "url": "https://<workspace>--smartbiblia-mcp-theses-fr-web.modal.run/mcp/"
    }
  }
}
```
